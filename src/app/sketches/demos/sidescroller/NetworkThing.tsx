...
export default function NetworkThing({ modelUrl = "/models/environment/slotmachine.glb", id, onActivate, ...props }: { modelUrl?: string; id?: string; onActivate?: () => void, [key: string]: any }) {
